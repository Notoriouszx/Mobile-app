class AppConstants {
  ...
  static const String recordsEndpoint = '/api/records';
  static const String uploadEndpoint = '/api/records/upload';

  static const String grantsEndpoint = '/api/grants';
  static const String doctorsEndpoint = '/api/users/doctors';
}
